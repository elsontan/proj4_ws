...
def generate_launch_description():
    ...
    # nav2_params_path = '/home/elson/proj4_ws/src/turtlebot3_manipulation/turtlebot3_manipulation_cartographer/lanes.yaml'
    ...
    world = LaunchConfiguration(
        ...
        default=PathJoinSubstitution(
            [
                ...
                'worlds',
                'libChair_world.model'
            ]
        )
    )

    map_arg = DeclareLaunchArgument('map', default_value='/home/elson/proj4_ws/src/turtlebot3_manipulation/turtlebot3_manipulation_cartographer/map/riot_map.yaml')
